...
then
  export COILED_SOFTWARE_NAME=$COILED_SOFTWARE_NAME_HEAD-$TEST_NAME-$GITHUB_EVENT_NUMBER-$COILED_SOFTWARE_NAME_TAIL
else
  export COILED_SOFTWARE_NAME=$COILED_SOFTWARE_NAME_HEAD-$TEST_NAME-$GITHUB_REF_TYPE-$REF_NAME_FORMATTED-$COILED_SOFTWARE_NAME_TAIL
fi
